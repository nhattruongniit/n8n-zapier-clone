  ...
  return (
    <>
      ...
      <EmptyView
        disabled={isCreating}
        onNew={handleCreate}
        message={<>You haven't created any workflows yet. <br /> Get started by creating a new workflow.</>}
      />
    </>
  )
}
...
export const WorkflowsItem = ({
  ...
  return (
    <EntityItem 
      ...
      subtitle={
        <>
          Updated {formatDistanceToNow((data.updatedAt), { addSuffix: true })} &bull; Created {formatDistanceToNow((data.createAt), { addSuffix: true })}
        </>
      }
      image={
